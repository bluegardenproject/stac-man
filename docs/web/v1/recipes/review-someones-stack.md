...
Or use [`sm untrack --reparent`](/v1/commands/untrack) if you want to keep the branches but drop them from `sm`'s graph.

## See also

- [`sm get`](/v1/commands/get) — flag reference.
- [`sm submit`](/v1/commands/submit) — the inverse: push your own stack as PRs.
