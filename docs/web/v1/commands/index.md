...
Every `sm` subcommand, grouped by intent. For the canonical workflow see [Your first stack](/v1/get-started/first-stack); for multi-step recipes see [Recipes](/v1/recipes/).
